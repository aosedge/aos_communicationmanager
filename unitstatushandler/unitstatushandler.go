...
func (instance *Instance) setComponentStatus(status cloudprotocol.ComponentStatus) bool { //nolint:dupl
	instance.statusMutex.Lock()
	defer instance.statusMutex.Unlock()
...
func (instance *Instance) setLayerStatus(status cloudprotocol.LayerStatus) bool { //nolint:dupl
	instance.statusMutex.Lock()
	defer instance.statusMutex.Unlock()
